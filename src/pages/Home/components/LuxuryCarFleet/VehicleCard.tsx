...
const VehicleCard: React.FC<VehicleCardProps> = ({image, name, price, specs, customClassName}) => {
  return (
    <div className={`car-card group bg-gray-50 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 ${customClassName}`}>
