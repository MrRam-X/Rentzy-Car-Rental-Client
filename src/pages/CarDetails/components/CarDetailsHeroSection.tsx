...
const CarDetailsHeroSection: React.FC<CarDetailsHeroSectionProps> = ({
  ...
  return (
    <section
      ...
      style={{ backgroundImage: `url(${generateImageUrl(primaryImageUri, carType)})` }}
    >
      <div className="absolute inset-0 bg-black/60"></div>
      <div className="relative container mx-auto px-4 h-full flex flex-col justify-center text-white max-w-6xl space-y-6">
        <p className="text-brand-gold tracking-[0.4em] uppercase text-sm mb-2">
          {carType} Cars
        </p>
